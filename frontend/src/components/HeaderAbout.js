...
const ProfileName = styled.h1`
	...
	margin-bottom: 2rem;
`;
const ProfileLocation = styled.h2`
	font-weight: 300;
	font-size: 3rem;
	margin-bottom: 2rem;
`;

const PowerLevelContainer = styled.p`
	/* 
  ##Device = Low Resolution Tablets, Mobiles (Landscape)
  ##Screen = B/w 766px to 1374px
*/
...
const PowerLevel = styled.span`
	font-weight: 700;
`;

const PowerLevelCode = styled.span`
	font-family: 'Fira Code';
	font-weight: 500;
`;

const PowerLevelCodeRed = styled.span`
	color: #f30a2e;
`;
			...
			<HeaderContainer>
				<VideoBGContainer>
					<VideoBGImg background={props.background}>
						...
						<Nav />
						<AboutMe>
							<ProfilePicture src="/assets/img/profile_picture.jpg" alt="Andrew Profile Picture" />

							<Profile>
								<ProfileName>Andrew</ProfileName>
								<ProfileLocation>London, UK</ProfileLocation>
								<PowerLevelContainer>
									<PowerLevel>Power Level: </PowerLevel>
									<PowerLevelCode>
										console.<PowerLevelCodeRed>log</PowerLevelCodeRed>(Math.<PowerLevelCodeRed>round</PowerLevelCodeRed>
										(Math.<PowerLevelCodeRed>random</PowerLevelCodeRed>() * 9000 + 9000));
									</PowerLevelCode>
								</PowerLevelContainer>
							</Profile>
						</AboutMe>
